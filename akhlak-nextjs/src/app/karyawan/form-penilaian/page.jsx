    ...
    <main className="main-content">
      ...
      <div className="card mb-24">
        <p className="text-muted" style={{marginBottom: '16px'}}>
          Berikut adalah daftar rekan sejawat atau atasan yang perlu Anda evaluasi berdasarkan Core Values AKHLAK untuk periode aktif.
        </p>
              ...
              <div key={task.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px', border: '1px solid #e2e8f0', borderRadius: '12px' }}>
                ...
                <div>
                  {task.status === 'selesai' ? (
                    ...
                    <Link href={`/karyawan/form-penilaian/${task.id}`} className="btn btn-primary">
